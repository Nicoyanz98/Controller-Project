...
class CollectorRenderer(Renderer):
    ...
    def draw_sticks_display(self):
        ...
        button_size = int(0.065 * screen_width)
        button_spacing = int(0.035 * screen_width)
