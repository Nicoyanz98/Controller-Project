...
class RendererLeft:
    ...
    def draw_sticks_display(self):
        ...
        stick_positions = ['stick_left_up_left', 'stick_left_up', 'stick_left_up_right',
                           'stick_left_left', 'stick_left_neutral', 'stick_left_right', 
                           'stick_left_down_left', 'stick_left_down', 'stick_left_down_right'
        ]

        for i, pos in enumerate(stick_positions):
            direction = pos.replace('stick_left_', '')
    ...
    def draw_gamepad_buttons(self):
        ...
        buttons_title = self.font.render("Botones Gamepad Izquierdo", True, AppConfig.TEXT)
        title_x = AppConfig.SCREEN_WIDTH // 2 - buttons_title.get_width() // 2
        self.screen.blit(buttons_title, (title_x, start_y - 30))

        button_positions = ['button_UP', 'button_LEFT', 'button_RIGHT', 'button_DOWN']
